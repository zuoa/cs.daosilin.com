...
def get_demo_player_stats(cup_name, player_id: str, play_day: str = None):
    ...
    metrics = {
        ...
        'avg_enemies_flashed_per_match': ratio(total('enemies_flashed'), completed),
        ...
        'avg_grenades_thrown_per_match': ratio(total('grenades_thrown'), completed),
        'avg_flash_thrown_per_match': ratio(total('flash_thrown'), completed),
        'avg_smoke_thrown_per_match': ratio(total('smoke_thrown'), completed),
        'avg_he_thrown_per_match': ratio(total('he_thrown'), completed),
        'avg_fire_thrown_per_match': ratio(
            total('molotov_thrown') + total('incendiary_thrown'), completed),
        ...
        'avg_unused_utility_value_per_match': ratio(total('unused_utility_value'), completed),
        'avg_trade_frags_per_match': ratio(total('trade_kills'), completed),
        ...
        'ct_kills_per_round': ratio(total('ct_kills'), total('rounds_ct')),
        't_kills_per_round': ratio(total('t_kills'), total('rounds_t')),
